        ...
        <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
            ...
            <div>
                ...
                <p className='text-gray-600 mb-4'>
                    Easily bring your ideas to life with free AI image generator.
                ...
                <p  className='text-gray-600'>
                    ...
                    images in seconds.From product visuals to character designs and potraits, even concepts 
                    that dont exist can be visualized effortlessly. Powered by advance AI technology, 
